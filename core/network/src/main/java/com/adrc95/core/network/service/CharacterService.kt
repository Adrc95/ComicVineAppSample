package com.adrc95.core.network.service
...
interface CharacterService {
    ...
    private companion object {
        const val LIST_FIELDS = "id,name,deck,image"
        const val DETAIL_FIELDS = "id,name,deck,description,site_detail_url,api_detail_url,image"
    }
}
